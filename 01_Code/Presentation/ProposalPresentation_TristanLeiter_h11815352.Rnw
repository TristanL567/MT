...
\begin{frame}[fragile]{Preliminary Data Analysis (R Integration)}
  ...
  <<summary_plot, fig.height=3.5>>=
  # We can generate plots dynamically
  par(mar=c(4,4,1,1))
  plot(iris$Sepal.Length, iris$Petal.Length, 
       col=iris$Species, pch=19,
       main="Cluster Separation Feasibility")
  legend("topleft", legend=levels(iris$Species), col=1:3, pch=19, cex=0.8)
  @
\end{frame}
